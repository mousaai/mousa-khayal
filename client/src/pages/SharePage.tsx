    ...
    return (
      <div className="min-h-screen bg-[#08090f] flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-xl font-bold text-white mb-2">الرابط غير صالح</h1>
          <p className="text-gray-500 mb-6">هذا الفيديو غير موجود أو انتهت صلاحيته</p>
          <Link href="/">
      ...
      <div className="border-b border-blue-500/20 bg-[#0a0b10]">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-gray-500 text-sm">
            ...
            <span>{(link.viewCount ?? 0).toLocaleString("ar-SA")} مشاهدة</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mt-6 flex items-center justify-between">
          <p className="text-gray-600 text-sm">
            تم الإنشاء بواسطة{" "}
            <span className="text-blue-400 font-semibold">خيال</span>
          </p>
          <Link href="/">

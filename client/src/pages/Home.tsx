...
const EXAMPLE_PROMPTS = [
  ...
  { text: "مدينة مستقبلية تحت الماء، أبراج زجاجية وأسماك تسبح حولها، إضاءة زرقاء درامية", lang: "AR", hint: "صورة" },
  // ── علوم وتعليم ──
  { text: "ذرة الكربون من الداخل، الإلكترونات تدور حول النواة بألوان نيون متوهجة", lang: "AR", hint: "صورة" },
  { text: "Visualize the Pythagorean theorem as a glowing 3D geometric proof", lang: "EN", hint: "image" },
  { text: "قانون الجاذبية لنيوتن: تفاحة تسقط مع خطوط القوة المرئية، تصوير سينمائي", lang: "AR", hint: "صورة" },
  ...
  { text: "خلية حية تحت المجهر، الميتوكوندريا داخل السيتوبلازم، ألوان فلورية متوهجة", lang: "AR", hint: "صورة" },
  { text: "Visualize the Fibonacci spiral in nature: shells, galaxies, flowers, golden ratio", lang: "EN", hint: "image" },
  { text: "الثقب الأسود يبتلع نجماً، موجات الجاذبية تتموج في الفضاء، إضاءة كونية درامية", lang: "AR", hint: "صورة" },
  // ── طبيعة وبيئة ──
  { text: "منظر جوي لأبوظبي من الأعلى، ناطحات السحاب تلمع تحت ضوء الغروب الذهبي", lang: "AR", hint: "صورة" },
  ...
  // ── تاريخي ──
  { text: "معركة عسكرية تاريخية في الصحراء العربية، فرسان بالسيوف، دخان وغروب الشمس الدرامي", lang: "AR", hint: "صورة" },
